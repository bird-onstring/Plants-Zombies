...
public class biu : MonoBehaviour
{
    ...
    public GameObject tudouleitxt;
    public bool ui=true, iu=true;



    public GameObject zidan, tudou;
    ...
    void Update()
    {
        ...
        if(killn>10)
        {
            tudouleitxt.SetActive(true);
            
            zidan.SetActive(false);
            tudou.SetActive(true);
            plant.GetComponent<biu2>().enabled = true;
            //plant.GetComponent<biu>().enabled = false;
        }
